...
class AddEditMatch extends Component {
  ...
  updateFields(match, teamOptions, teams, type, matchId) {
    ...
    for(let key in newFormdata) {
      //console.log(match[key]) => sonucunda aldığımız datalar formdata'da düzenlediğimiz her bir attrbute'e denk geliyor.
      //ie. date: 2018-11-30 local: Cardiff localResult: 0 ...
    ...
    return (
      <AdminLayout>
        <div className="editmatch_dialog_wrapper">
          ...
          <div onSubmit={(event) => this.submitForm(event)}>
            <form>
              <FormField 
                id="date"
              ...
              <div className="split_fields">
                <div className="label_inputs">Result</div>
                <FormField 
                  id="result"
